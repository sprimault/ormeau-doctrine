...
abstract class EvenementBase
{
    ...
    #[ORM\Column(
        ...
        options: ['default' => 'CURRENT_TIMESTAMP', 'comment' => 'CURRENT_TIMESTAMP s\'écrit ainsi au catalogue'],
    )]
    ...
    #[ORM\Column(name: 'jour', type: 'date_immutable', options: ['default' => 'CONVERT(date, GETDATE())'])]
    ...
    #[ORM\Column(
        ...
        type: 'date_immutable',
        nullable: true,
        options: ['default' => 'CONVERT(date, GETDATE())', 'comment' => 'Forme qu\'écrit Doctrine sous DBAL 3'],
    )]
    ...
    #[ORM\Column(
        ...
        type: 'time_immutable',
        nullable: true,
        options: ['default' => 'CONVERT(time, GETDATE())'],
    )]
