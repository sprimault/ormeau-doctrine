...
// Généré par Ormeau depuis la base associations et réécrit à chaque génération : le code propre à Commande va dans Commande.php.
...
abstract class CommandeBase
{
    ...
    /** Lecture seule : écrite par l'association commandeRemplacee. */
