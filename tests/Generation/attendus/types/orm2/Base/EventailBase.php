...
abstract class EventailBase
{
    ...
    #[ORM\Column(name: 'charge_utile', type: 'json', nullable: true, options: ['jsonb' => true])]
    ...
    public function getCompteurLong(): string
    {
        return $this->compteurLong;
    }

    public function setCompteurLong(string $compteurLong): static
    {
